            ...
            <v-card flat color="#f5f5f5" style="border: 1px solid #d9d9d9; margin-top: 20px">
              <v-card-subtitle style="border-bottom: 1px solid #eaebee">
                <v-layout>
                  ...
                  <!--최근 주문상품 상세페이지로 이동-->
                  <router-link :to="{name: 'OrderDetailView', params: {orderNo: index}}"
                    ...
                    >
                      <v-card-title style="font-weight: bold; font-size: 15px">
                        ...
                        <div style="margin-right: 100%">
                          <v-chip outlined style="float: right;" color="#DAA520" x-small
                                  v-if="itemList.orderStatus == '입금완료'">입금 완료
                          </v-chip>
                          <v-chip outlined style="float: right;" color="#44a4fc" x-small
                                  v-if="itemList.orderStatus == '배송 중'">배송 중
                          </v-chip>
                          <v-chip outlined style="float: right;" color="green" x-small
                                  v-if="itemList.orderStatus == '배송 완료'">배송 완료
                          </v-chip>
                          <v-chip outlined style="float: right;" color="warning" x-small
                                  v-if="itemList.orderStatus == '교환'">교환
                          </v-chip>
                          <v-chip outlined style="float: right;" color="grey" x-small
                                  v-if="itemList.orderStatus == '취소'">취소
                          </v-chip>
                          <v-chip outlined style="float: right;" color="red" x-small
                                  v-if="itemList.orderStatus == '환불'">환불
                          </v-chip>
                        </div>
                        ...
                        <div style="overflow: hidden">
                          ...
                          <router-link :to="{ name: 'ProductReadView',
                                    params: { productNo: itemList.product.productNo.toString() } }"
                                       style="text-decoration: none; color: black;">
                      ...
                      <v-card-subtitle style="font-size: 12px">
                        {{ itemList.product.productInfo.category }} | {{ itemList.product.price | comma }}원 |
                        {{ itemList.quantity }}개
                      </v-card-subtitle>
                    </v-card>
